...
def change_btn_status(day, btn_index):
    ...
    if day == "sat":
        if saturday_buttons[btn_index].cget("text") == "X":
            ...
            saturday_buttons[btn_index].configure(bg=default_color)
    ...
    if day == "sun":
        if sunday_buttons[btn_index].cget("text") == "X":
            ...
            sunday_buttons[btn_index].configure(bg=default_color)
...
def change_day_status(day):
    ...
    if str(day) == "0":
        ...
        for i in range(14):
            if i == 4:
                continue
            if not busy_day:
                saturday_buttons[i].configure(text="X", bg=default_color)
            else:
                saturday_buttons[i].configure(text="__", bg=default_color)
        ...
        for i in range(14):
            if i == 4:
                continue
            if not busy_day:
                sunday_buttons[i].configure(text="X", bg=default_color)
            else:
                sunday_buttons[i].configure(text="__", bg=default_color)
    ...
    # Display
    print("DAY {} STATUS CHANGE".format(int(day) + 1))
    display_combs()
...
def change_hour_status(h):
    ...
    if str(h) == "08":
        ...
        for i in range(7):
            if not busy_hour:
                btn_list[i][9].configure(text="X", bg=default_color)
            else:
                btn_list[i][9].configure(text="__", bg=default_color)
        ...
        for i in range(7):
            if not busy_hour:
                btn_list[i][10].configure(text="X", bg=default_color)
            else:
                btn_list[i][10].configure(text="__", bg=default_color)
        ...
        for i in range(7):
            if not busy_hour:
                btn_list[i][11].configure(text="X", bg=default_color)
            else:
                btn_list[i][11].configure(text="__", bg=default_color)
        ...
        for i in range(7):
            if not busy_hour:
                btn_list[i][12].configure(text="X", bg=default_color)
            else:
                btn_list[i][12].configure(text="__", bg=default_color)
        ...
        for i in range(7):
            if not busy_hour:
                btn_list[i][13].configure(text="X", bg=default_color)
            else:
                btn_list[i][13].configure(text="__", bg=default_color)
